...
random_color = sample(colours(distinct = TRUE), 1)
...
17. Consulut your grandmother - and prove her wrong
18. Push an establisheed finding to the extreme
19. Read biographies and liteature, and be a well-rounded media consumer
...
## Für nächste Woche:
+   Account bei [osf.io](https://osf.io/register) erstellen
    +   dem [Projekt beitreten](https://osf.io/9axfe/)
+   Studienideen überlegen.
...
`r icon::fa_smile(size = 5, color = random_color)`
